...
public class AmethystGenerator implements IWorldGenerator {
    ...
    private void generateSurface(World world, Random rand, int chunkX, int chunkZ) {
        for (int k = 0; k < 2; k++) {
            ...
            (new WorldGenMinable(PixelUtilitiesBlocks.amethystOre.getDefaultState(), 3, BlockHelper.forBlock(Blocks.stone))).generate(world, rand, new BlockPos(firstBlockXCoord, firstBlockYCoord, firstBlockZCoord));
        }
    }
