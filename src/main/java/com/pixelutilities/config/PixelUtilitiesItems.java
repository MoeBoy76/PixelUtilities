...
public class PixelUtilitiesItems {
	...
	public static void load(Configuration cfg) {
		...
		Basemod.instance.fightingBadgeItem = new FightingBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:FightingBadge");
		Basemod.instance.flyingBadgeItem = new FlyingBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:FlyingBadge");
		Basemod.instance.groundBadgeItem = new GroundBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:GroundBadge");
		Basemod.instance.normalBadgeItem = new NormalBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:NormalBadge");
		Basemod.instance.poisonBadgeItem = new PoisonBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:PoisonBadge");
		Basemod.instance.rockBadgeItem = new RockBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:RockBadge");
		Basemod.instance.ghostBadgeItem = new GhostBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:GhostBadge");
		Basemod.instance.steelBadgeItem = new SteelBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:SteelBadge");
		Basemod.instance.fireBadgeItem = new FireBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:FireBadge");
		Basemod.instance.waterBadgeItem = new WaterBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:WaterBadge");
		Basemod.instance.grassBadgeItem = new GrassBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:GrassBadge");
		Basemod.instance.electricBadgeItem = new ElectricBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:ElectricBadge");
		Basemod.instance.darkBadgeItem = new DarkBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:DarkBadge");
		Basemod.instance.iceBadgeItem = new IceBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:IceBadge");
		Basemod.instance.psychicBadgeItem = new PsychicBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:PsychicBadge");
		Basemod.instance.dragonBadgeItem = new DragonBadgeItem().setCreativeTab(PixelUtilitiesCreativeTabs.tabPixelmonBadges).setTextureName("PixelUtilities:DragonBadge");
