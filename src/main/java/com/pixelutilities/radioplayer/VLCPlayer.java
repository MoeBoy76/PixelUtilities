package com.pixelutilities.radioplayer;
...
public class VLCPlayer implements Runnable {
    ...
    public boolean isPlaying() {
        return Basemod.instance.vlcLoaded && !killed && mediaPlayerComponent != null && mediaPlayerComponent.getMediaPlayer().isPlaying();
    }
