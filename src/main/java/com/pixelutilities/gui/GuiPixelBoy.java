...
import com.pixelutilities.arcade.interfaces.IArcadeGame;
...
import com.pixelutilities.arcade.interfaces.IArcadeGame.KEY;
...
public class GuiPixelBoy extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        drawTexturedModalRect(offsetX, offsetY, 0, 0, game.renderGraphics().getWidth(), game.renderGraphics().getHeight());
