...
public class ModelRadioHand extends ModelBase {
    //fields
    public ModelRenderer Body;
    public ModelRenderer Speaker_Right;
    public ModelRenderer Speaker_Left;
    public ModelRenderer HandleBaseRight;
    public ModelRenderer HandleBaseLeft;
    public ModelRenderer HandleBar;
    public ModelRenderer Antenna;

    public ModelRadioHand() {
        textureWidth = 32;
        textureHeight = 16;
    ...
    public void render(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
