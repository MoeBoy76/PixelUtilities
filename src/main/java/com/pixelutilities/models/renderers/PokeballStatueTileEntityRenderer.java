...
public class PokeballStatueTileEntityRenderer extends TileEntitySpecialRenderer {
    ...
    public static ResourceLocation Walrus = new ResourceLocation("pixelutilities:textures/specialmodels/PokeballStatue.png");
    public static ResourceLocation Walrus2 = new ResourceLocation("pixelutilities:textures/models/PokeballStatue.obj");
