...
import com.pixelutilities.models.BoxModel;
...
public class BoxRenderer extends TileEntitySpecialRenderer {
	ResourceLocation texture = new ResourceLocation("pixelutilities:textures/specialmodels/Box.png");
