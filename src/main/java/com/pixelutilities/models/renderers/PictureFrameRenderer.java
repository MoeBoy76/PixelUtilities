...
import com.pixelutilities.models.PictureFrameModel;
...
public class PictureFrameRenderer extends TileEntitySpecialRenderer {
    ResourceLocation texture = new ResourceLocation("pixelutilities:textures/specialmodels/PictureFrame1.png");
    //The model of your block
    private final PictureFrameModel model;

    public PictureFrameRenderer() {
        this.model = new PictureFrameModel();
    }
