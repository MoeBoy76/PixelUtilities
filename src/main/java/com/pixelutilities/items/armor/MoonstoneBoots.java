...
public class MoonstoneBoots extends ItemArmor
{
	private boolean isEquipped = false;

	public MoonstoneBoots(ArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
	...
	public void registerIcons(IIconRegister par1IconRegister) {
		this.itemIcon = par1IconRegister.registerIcon("pixelutilities:armor/MoonstoneBoots");
	}
		...
		if(player instanceof EntityPlayerMP)
		{
			...
			if(thePlayer.getEquipmentInSlot(1) != null)
			{
				...
				if(thePlayer.getEquipmentInSlot(1) != null && thePlayer.getEquipmentInSlot(2) != null && thePlayer.getEquipmentInSlot(3) != null && thePlayer.getEquipmentInSlot(4) != null)
				{
					...
					if(boots instanceof MoonstoneBoots && legs instanceof MoonstoneLegs && plate instanceof MoonstonePlate && helm instanceof MoonstoneHelmet)
					{
						isEquipped = true;
					...
					else if(boots instanceof MoonstoneBoots)
					{
						isEquipped = true;
						stack = new ItemStack(Basemod.instance.moonstoneBoots, 1, boots.getDamage(stack));
					}
					else
					{
						isEquipped = false;
