...
public class CrystalBoots extends ItemArmor {
	...
	public CrystalBoots(ArmorMaterial par2EnumArmorMaterial, int par3, int par4, boolean isRegular) {
	...
	public void registerIcons(IIconRegister par1IconRegister) {
		if(isRegular)
		{
			this.itemIcon = par1IconRegister.registerIcon("pixelutilities:armor/PlasmaBoots");
		}
		else
		{
			this.itemIcon = par1IconRegister.registerIcon("pixelutilities:armor/NeoPlasmaBoots");
		}
	}
}