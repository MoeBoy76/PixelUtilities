		...
		if(player instanceof EntityPlayerMP)
		{
			...
			if(thePlayer.getEquipmentInSlot(1) != null)
			{
				...
				if(thePlayer.getEquipmentInSlot(1) != null && thePlayer.getEquipmentInSlot(2) != null && thePlayer.getEquipmentInSlot(3) != null && thePlayer.getEquipmentInSlot(4) != null)
				{
					...
					if(boots instanceof WaterstoneBoots && legs instanceof WaterstoneLegs && plate instanceof WaterstonePlate && helm instanceof WaterstoneHelmet)
					{
						isEquipped = true;
						if(!stack.isItemEnchanted())
							stack.addEnchantment(Enchantment.aquaAffinity, 2);
						thePlayer.addPotionEffect(new PotionEffect(Potion.waterBreathing.getId(), 20));
					}
					else if(boots instanceof WaterstoneBoots)
					{
						isEquipped = true;
						stack = new ItemStack(Basemod.instance.waterstoneBoots, 1, boots.getDamage(stack));
					}
					else
					{
						isEquipped = false;
