...
public class WaterstoneHelmet extends ItemArmor {

    public WaterstoneHelmet(ArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon("pixelutilities:armor/WaterstoneHelmet");
    }
}
