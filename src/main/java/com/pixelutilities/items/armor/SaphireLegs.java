...
public class SaphireLegs extends ItemArmor {
    ...
    public SaphireLegs(ArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon("pixelutilities:armor/SaphireLeggings");
    }
}
